...
func exportAppStateAndTMValidators(
	logger log.Logger, db dbm.DB, traceStore io.Writer, height int64, forZeroHeight bool, kickValidators []sdk.ValAddress,
	...
	return gApp.ExportAppStateAndValidators(forZeroHeight, kickValidators)
}
