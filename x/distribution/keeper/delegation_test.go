...
func TestCalculateRewardsBasic(t *testing.T) {
	...
	msg := staking.NewMsgCreateValidator(valOpAddr1, valConsPk1,
		sdk.NewCoin(sdk.DefaultBondDenom, sdk.NewInt(100)), staking.Description{}, commission, sdk.OneInt(), "fifty")
...
func TestCalculateRewardsAfterSlash(t *testing.T) {
	...
	msg := staking.NewMsgCreateValidator(valOpAddr1, valConsPk1,
		sdk.NewCoin(sdk.DefaultBondDenom, valTokens), staking.Description{}, commission, sdk.OneInt(), "staked")
	got := sh(ctx, msg)
...
func TestCalculateRewardsMultiDelegator(t *testing.T) {
	...
	commission := staking.NewCommissionMsg(sdk.NewDecWithPrec(5, 1), sdk.NewDecWithPrec(5, 1), sdk.NewDec(0))
	msg := staking.NewMsgCreateValidator(valOpAddr1, valConsPk1,
		sdk.NewCoin(sdk.DefaultBondDenom, sdk.NewInt(100)), staking.Description{}, commission, sdk.OneInt(), "staked")
	require.True(t, sh(ctx, msg).IsOK())
...
func TestWithdrawDelegationRewardsBasic(t *testing.T) {
	...
	require.Equal(t,
		sdk.Coins{sdk.NewCoin(sdk.DefaultBondDenom, expTokens), sdk.NewCoin(fmt.Sprintf("staked%s", sdk.DefaultBondDenom), valTokens)},
	...
	// assert correct balance
	exp := balanceTokens.Sub(valTokens).Add(initial.Quo(sdk.NewInt(2)))
	require.Equal(t,
		sdk.Coins{sdk.NewCoin(sdk.DefaultBondDenom, exp), sdk.NewCoin(fmt.Sprintf("staked%s", sdk.DefaultBondDenom), valTokens)},
		ak.GetAccount(ctx, sdk.AccAddress(valOpAddr1)).GetCoins(),
	)
}
