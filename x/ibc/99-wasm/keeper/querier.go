...
func queryContractInfo(ctx sdk.Context, address string, req abci.RequestQuery, keeper Keeper) ([]byte, error) {
	addr, err := types.AddressFromString(address)
	if err != nil {
...
func queryContractListByCode(ctx sdk.Context, codeIDstr string, req abci.RequestQuery, keeper Keeper) ([]byte, error) {
	...
	keeper.ListContractInfo(ctx, func(addr types.Address, info types.ContractInfo) bool {
...
func queryContractState(ctx sdk.Context, address, queryMethod string, req abci.RequestQuery, keeper Keeper) ([]byte, error) {
	contractAddr, err := types.AddressFromString(address)
	if err != nil {
