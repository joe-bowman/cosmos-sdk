...
type ClientState struct {
	...
	// Wasm blob responsible for validating headers and justifications.
	ValidityPredicateAddress Address `json:"validity_predicate_address" yaml:"validity_predicate_address"`
}

//// InitializeFromMsg creates a tendermint client state from a CreateClientMsg
//func InitializeFromMsg(msg MsgCreateWasmClient) (ClientState, error) {
//	return Initialize(
//		msg.GetClientID(), msg.TrustingPeriod, msg.UnbondingPeriod, msg.MaxClockDrift, msg.Header, msg.WasmId,
//	)
//}
//
...
//func Initialize(
//	id string, trustingPeriod, ubdPeriod, maxClockDrift time.Duration, header Header, validityPredicateId int,
//) (ClientState, error) {
//
...
//	}
//
//	clientState := NewClientState(id, trustingPeriod, ubdPeriod, maxClockDrift, header, validityPredicateId)
//	return clientState, nil
//}

// NewClientState creates a new ClientState instance
func NewClientState(
	id string, trustLevel tmmath.Fraction, trustingPeriod, ubdPeriod, maxClockDrift time.Duration, header Header, validityPredicateAddress Address,
) ClientState {
	return ClientState{
		ID:                       id,
		...
		LastHeader:               header,
		FrozenHeight:             0,
		ValidityPredicateAddress: validityPredicateAddress,
	}
}
